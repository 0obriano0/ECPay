 ...
 *
 */
public class CVSOrBARCODEPaymentInfoURLObj {
	...
	public String toString() {
		return "CVSOrBARCODERequestObj [MerchantID=" + MerchantID + ", MerchantTradeNo=" + MerchantTradeNo
				+ ", RtnMsg=" + RtnMsg + ", TradeNo=" + TradeNo + ", TradeAmt=" + TradeAmt
				+ ", PaymentType=" + PaymentType + ", TradeDate="
				+ TradeDate + ", SimulatePaid=" + CheckMacValue + ", PaymentNo="
